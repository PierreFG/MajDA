...
import { useFetchLatticesQuery } from '../../app/services/api';

const Comparabilities = () => {
    const {data: lattices, isLoading, isSuccess, isError} = useFetchLatticesQuery();
    ...
    return (
        ...
        >
            ...
            {
                (isError || lattices==null) ?
                    <p>No comparabilities found</p>
                    :
                    <LatticeGrid lattices={lattices} />
            }
            {/* <Form.Select 
